"""HTTP routes for patient-consent-service.

Generic CRUD over the `patient_consent` table. Every mutating endpoint publishes a
domain event (patient.consent.updated) and an audit event; reads publish audit only.
...
CREATED_EVENT = ""
UPDATED_EVENT = "patient.consent.updated"
